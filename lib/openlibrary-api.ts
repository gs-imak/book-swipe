...
// Covers for OL books come straight from the Open Library cover image (-L, by
// cover_i) — correct edition, reliable, ~500px. A higher-res iTunes cover is
// layered on (when the book has an ISBN) by upgradeCoversWithItunes.
